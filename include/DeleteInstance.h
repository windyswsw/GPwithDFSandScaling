void DeleteInstance(Population* CurrentPop, CommonList* CurCommonListNew, int Pol, int PosOfChangingNF, int OriginalInst, float NoOfServers, float NoOfLinks, short int MaxLinksCap, int w1, int w2, int w3, int w4, int w5){
	...
	int NFtoChangeNewCapacity = (NFtoChangeCapacity / 2); // half the capacity
