...
void OldMutationForInitialSolution(Population* CurrentPop, CommonList* CurCommonListNew, short int FullSolSelected, int MutationPol, float NoOfServers, float NoOfLinks, short int MaxLinksCap, int w1, int w2, int w3, int w4, int w5){
